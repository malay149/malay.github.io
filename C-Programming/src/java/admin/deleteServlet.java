        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (dataSource != null) {
                ...
                try {
                    ...
                    String deleteQuery = "Delete from `credential` where login=? and type=?";
                     try (PreparedStatement deleteStatement = dbConn.prepareStatement(deleteQuery)) {
                                             deleteStatement.setString(1, login_name);
                                             deleteStatement.setString(2, user_type);
