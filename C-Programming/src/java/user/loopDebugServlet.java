 ...
 * @author theth
 */
public class loopDebugServlet extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (dataSource != null) {
                ...
                try {
                    ...
                    String queryString = "SELECT debug,record_id FROM `record` WHERE user_id=? and program_id=?;";
                    ...
                    if (recID > 0) {
                        ...
                        oldDebug = oldDebug + 1;
                        String updateQuery = "update `record` SET debug=? WHERE user_id=? and program_id=?;";
                        try (PreparedStatement updateStatement = dbConn.prepareStatement(updateQuery)) {
                            updateStatement.setInt(1, oldDebug);
